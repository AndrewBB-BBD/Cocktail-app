...
public class LoginModel : PageModel
{
    ...
    {
        var UserNameExists = _cocktailDBContext.UserLogins.FirstOrDefault(first => first.Username == Credential.UserName); //Finding Existence of UserName in db
        if(UserNameExists is not null) {
            byte[] passwordToDecode = UserNameExists.UserPassword; //Getting Password for existing user.
